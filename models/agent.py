...
class Agent(models.Model):
    ...
    def ajouter_dates_manquantes(self, liste_dates):
        ...
        for employee in equipe:
            if employee.mission_id.state == "en_cours" and employee.mission_id.date_depart >= debut_mois_dernier.date() and employee.mission_id.date_retour <= fin_mois_dernier.date() or employee.mission_id.state == "terminer" and employee.mission_id.date_depart >= debut_mois_dernier.date() and employee.mission_id.date_retour <= fin_mois_dernier.date():
