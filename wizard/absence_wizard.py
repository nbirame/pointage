        ...
        for employee in employees:
            ...
            if participants:
                ...
                for agent in participants:
                    ...
                    if (date_start >= self.start_date and date_end <= self.end_date) and (
                        ...
                        total_number_of_working_hours = int(
                            (self.nombre_jours_sans_weekend(self.start_date,
                                                            self.end_date) - number_of_days_absence_legal) * heure_travail.worked_hours)
                    elif date_start >= self.start_date and date_end >= self.end_date and (
                            agent.employee_id.id == employee.id):
                        number_day_of_atelier += self.nombre_jours_sans_weekend(date_start,
                                                                                self.end_date)
                        number_of_days_absence_legal += number_day_of_atelier
                        total_number_of_working_hours = int(
                            ...
                            date_start <= self.start_date and date_end <= self.end_date):
